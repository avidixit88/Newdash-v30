...
/* v2.16 BuildWell repair: all custom CSS stays inside the style block.
   The lane selector should feel native to the Signal Room, not like default Streamlit controls. */
.scan-selector-shell{
  max-width:980px!important;
  ...
  background:radial-gradient(circle at 12% 0%,rgba(90,162,255,.12),transparent 32%),linear-gradient(135deg,rgba(14,25,43,.84),rgba(13,17,26,.78))!important;
  box-shadow:0 22px 60px rgba(0,0,0,.28),inset 0 1px 0 rgba(255,255,255,.07)!important;
}
.lane-card-zone{
...
.lane-choice-card{
  ...
  margin-bottom:12px!important;
  background:radial-gradient(circle at 15% -4%,rgba(255,255,255,.07),transparent 34%),linear-gradient(145deg,rgba(13,22,39,.92),rgba(5,10,20,.94))!important;
  box-shadow:0 20px 52px rgba(0,0,0,.27),inset 0 1px 0 rgba(255,255,255,.07)!important;
}
.lane-choice-card.selected{opacity:1!important;filter:none!important;}
.lane-choice-card.unselected{opacity:.74!important;filter:saturate(.72)!important;}
.lane-choice-card.lane-violet{border:1px solid rgba(139,92,246,.58)!important;}
.lane-choice-card.lane-blue{border:1px solid rgba(59,130,246,.58)!important;}
.lane-choice-card.lane-green{border:1px solid rgba(45,212,130,.52)!important;}
.lane-choice-card.lane-gold{border:1px solid rgba(216,184,108,.55)!important;}
.lane-choice-topline{display:flex!important;align-items:center!important;justify-content:space-between!important;margin-bottom:24px!important;}
.lane-choice-icon{
  width:41px!important;height:41px!important;border-radius:14px!important;
  display:flex!important;align-items:center!important;justify-content:center!important;
  background:linear-gradient(135deg,rgba(255,255,255,.08),rgba(255,255,255,.025))!important;
  border:1px solid rgba(255,255,255,.09)!important;color:#dbe8ff!important;
  box-shadow:inset 0 1px 0 rgba(255,255,255,.08),0 10px 24px rgba(0,0,0,.24)!important;
  font-size:.80rem!important;font-weight:900!important;
}
.lane-choice-check{
  ...
  background:linear-gradient(135deg,#f5dc8b,#b98a32)!important;color:#07101d!important;
  border:1px solid rgba(255,232,165,.38)!important;
  box-shadow:0 10px 24px rgba(0,0,0,.32),inset 0 1px 0 rgba(255,255,255,.38)!important;
}
.lane-choice-card.unselected .lane-choice-check{
  background:rgba(7,13,25,.58)!important;color:#8796b1!important;border:1px solid rgba(164,183,219,.22)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.06)!important;
}
.lane-choice-title{font-size:1.02rem!important;font-weight:950!important;letter-spacing:-.02em!important;color:#f4f7ff!important;margin-bottom:8px!important;}
.lane-choice-subtitle,.lane-choice-note{font-size:.90rem!important;color:#aebbd0!important;line-height:1.45!important;}

/* Streamlit action chips under each card: small, centered, understated. */
.st-key-lane_toggle_0,.st-key-lane_toggle_1,.st-key-lane_toggle_2,.st-key-lane_toggle_3{
  display:flex!important;justify-content:center!important;align-items:center!important;width:100%!important;margin:0 auto!important;
}
.st-key-lane_toggle_0 div[data-testid="stButton"],.st-key-lane_toggle_1 div[data-testid="stButton"],.st-key-lane_toggle_2 div[data-testid="stButton"],.st-key-lane_toggle_3 div[data-testid="stButton"]{
  width:100%!important;display:flex!important;justify-content:center!important;
}
.st-key-lane_toggle_0 button,.st-key-lane_toggle_1 button,.st-key-lane_toggle_2 button,.st-key-lane_toggle_3 button{
  width:98px!important;min-width:98px!important;max-width:98px!important;height:28px!important;min-height:28px!important;
  padding:0 10px!important;margin:0 auto!important;border-radius:999px!important;
  border:1px solid rgba(216,184,108,.34)!important;
  background:linear-gradient(135deg,rgba(16,26,43,.80),rgba(8,13,24,.86))!important;
  color:#eed892!important;font-size:.72rem!important;font-weight:850!important;letter-spacing:.01em!important;line-height:1!important;
  box-shadow:0 8px 18px rgba(0,0,0,.18),inset 0 1px 0 rgba(255,255,255,.06)!important;
}
.st-key-lane_toggle_0 button:hover,.st-key-lane_toggle_1 button:hover,.st-key-lane_toggle_2 button:hover,.st-key-lane_toggle_3 button:hover{
  transform:translateY(-1px)!important;border-color:rgba(242,218,142,.68)!important;color:#fff2bc!important;background:linear-gradient(135deg,rgba(23,37,61,.92),rgba(9,15,27,.94))!important;
}

.selection-center-wrap{width:100%!important;display:flex!important;justify-content:center!important;align-items:center!important;margin:34px auto 28px auto!important;padding:0 16px!important;text-align:center!important;}
.lane-selection-summary.centered{
  width:auto!important;max-width:min(860px,90vw)!important;margin:0 auto!important;padding:12px 21px!important;min-height:50px!important;
  ...
  background:linear-gradient(135deg,rgba(15,25,44,.76),rgba(8,13,24,.72))!important;
...
.lane-selection-summary.centered strong{white-space:nowrap!important;color:#ffffff!important;font-weight:950!important;}
.lane-selection-summary.centered span:last-child{color:#b9c6dc!important;white-space:normal!important;}
.summary-dot{width:25px!important;height:25px!important;min-width:25px!important;border-radius:999px!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;background:linear-gradient(135deg,#6f58d9,#4731a7)!important;color:#fff!important;font-weight:950!important;box-shadow:0 8px 20px rgba(0,0,0,.22),inset 0 1px 0 rgba(255,255,255,.18)!important;}

.run-button-zone{display:flex!important;justify-content:center!important;align-items:center!important;width:100%!important;margin:30px auto 52px auto!important;text-align:center!important;}
.st-key-run_analysis,.st-key-run_analysis div[data-testid="stButton"]{display:flex!important;justify-content:center!important;align-items:center!important;width:100%!important;}
.st-key-run_analysis button{
  width:340px!important;max-width:340px!important;min-height:66px!important;border-radius:999px!important;
  border:1px solid rgba(255,228,154,.95)!important;
  background:radial-gradient(circle at 28% 14%,rgba(255,255,255,.34),transparent 25%),linear-gradient(135deg,#f8df91 0%,#d4aa4c 47%,#94691f 100%)!important;
  color:#06101f!important;font-size:1.05rem!important;font-weight:950!important;letter-spacing:.005em!important;
  box-shadow:0 0 0 1px rgba(216,184,108,.22),0 0 38px rgba(216,184,108,.20),0 24px 64px rgba(0,0,0,.48),inset 0 1px 0 rgba(255,255,255,.52)!important;
}
.st-key-run_analysis button:hover{transform:translateY(-2px)!important;border-color:rgba(255,240,190,1)!important;box-shadow:0 0 0 1px rgba(216,184,108,.28),0 0 48px rgba(216,184,108,.26),0 30px 76px rgba(0,0,0,.52),inset 0 1px 0 rgba(255,255,255,.60)!important;}
.st-key-run_analysis button:disabled{opacity:.42!important;filter:saturate(.58)!important;cursor:not-allowed!important;}

@media(max-width:900px){
  .scan-selector-shell{margin:18px auto 28px auto!important;padding:24px 20px!important;border-radius:22px!important;}
  .lane-choice-card{min-height:158px!important;padding:19px 20px!important;}
  .st-key-lane_toggle_0 button,.st-key-lane_toggle_1 button,.st-key-lane_toggle_2 button,.st-key-lane_toggle_3 button{width:92px!important;min-width:92px!important;max-width:92px!important;height:28px!important;font-size:.70rem!important;}
  .selection-center-wrap{margin:26px auto 20px auto!important;padding:0 8px!important;}
  .lane-selection-summary.centered{max-width:92vw!important;border-radius:18px!important;text-align:left!important;justify-content:flex-start!important;}
  .st-key-run_analysis button{width:286px!important;max-width:286px!important;min-height:60px!important;font-size:.98rem!important;}
}
